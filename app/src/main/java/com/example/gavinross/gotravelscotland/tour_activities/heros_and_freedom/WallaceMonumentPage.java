...
public class WallaceMonumentPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_wallace_monument_multi.mp4";
        mHeadingTextView.setText(R.string.wallace_monument_title);
        mParagraphView.setText(R.string.wallace_monument_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WallaceMonumentPage.this, BattleOfBannockbunPage.class);
