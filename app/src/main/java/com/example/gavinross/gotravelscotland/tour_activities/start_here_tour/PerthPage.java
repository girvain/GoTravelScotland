...
public class PerthPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_perth_multi.mp4";
        mHeadingTextView.setText(R.string.perth_title);
        mParagraphView.setText(R.string.perth_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PerthPage.this, DunkeldPage.class);
