...
public class CairngormsPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_cairngorms_multi.mp4";
        mHeadingTextView.setText(R.string.cairgorms_title);
        mParagraphView.setText(R.string.cairgorms_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CairngormsPage.this, LochLagganPage.class);
