...
public class KingdomOfFife extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_kingdom_of_fife_multi.mp4";
        mHeadingTextView.setText(R.string.kingdom_of_fife_title);
        mParagraphView.setText(R.string.the_kingdome_of_fife_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(KingdomOfFife.this, LochLevenPage.class);
