...
public class LochLagganPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_loch_laggan_multi.mp4";
        mHeadingTextView.setText(R.string.loch_laggan_title);
        mParagraphView.setText(R.string.loch_laggen_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LochLagganPage.this, WhiskyPage.class);
