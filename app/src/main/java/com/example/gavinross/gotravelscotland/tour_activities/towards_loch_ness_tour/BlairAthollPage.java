...
public class BlairAthollPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_blair_atholl_multi.mp4";
        mHeadingTextView.setText(R.string.blair_atholl_title);
        mParagraphView.setText(R.string.blair_atholl_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BlairAthollPage.this, CairngormsPage.class);
