...
public class CommandoMemorialPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_commando_memorial_multi.mp4";
        mHeadingTextView.setText(R.string.commando_memorial_title);
        mParagraphView.setText(R.string.commando_memorial_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CommandoMemorialPage.this, FortWilliamPage.class);
