...
public class WhiskyPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_whisky_multi.mp4";
        mHeadingTextView.setText(R.string.whiskey_title);
        mParagraphView.setText(R.string.whiskey_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WhiskyPage.this, FortAugustusPage.class);
