...
public class StirlingCastlePage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_stirling_castle_multi.mp4";
        mHeadingTextView.setText(R.string.stirling_castle_title);
        mParagraphView.setText(R.string.stirling_castle_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(StirlingCastlePage.this, WallaceMonumentPage.class);
