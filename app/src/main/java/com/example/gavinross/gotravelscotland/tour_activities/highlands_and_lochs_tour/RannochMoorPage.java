...
public class RannochMoorPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_rannoch_moor_multi.mp4";
        mHeadingTextView.setText(R.string.rannoch_moor_title);
        mParagraphView.setText(R.string.rannoch_moor_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RannochMoorPage.this, TheTrossachsPage.class);
