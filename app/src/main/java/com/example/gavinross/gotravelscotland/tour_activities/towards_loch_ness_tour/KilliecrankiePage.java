...
public class KilliecrankiePage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_killiecrankie_multi.mp4";
        mHeadingTextView.setText(R.string.killiecrankie_title);
        mParagraphView.setText(R.string.killiecrankie_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(KilliecrankiePage.this, BlairAthollPage.class);
