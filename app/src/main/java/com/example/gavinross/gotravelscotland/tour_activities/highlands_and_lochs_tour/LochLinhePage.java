...
public class LochLinhePage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_loch_linnhe_multi.mp4";
        mHeadingTextView.setText(R.string.loch_linhe_title);
        mParagraphView.setText(R.string.loch_linhe_title);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LochLinhePage.this, MountainsAndGeologyPage.class);
