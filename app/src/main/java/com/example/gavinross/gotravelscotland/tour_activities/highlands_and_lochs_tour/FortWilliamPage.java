...
public class FortWilliamPage extends TourActivity {
    public void onCreate(Bundle savedInstanceBundle) {
        ...
        String videoFilePath = "/mnt/extSdCard/gts_fort_william_multi.mp4";
        mHeadingTextView.setText(R.string.fort_william_title);
        mParagraphView.setText(R.string.fort_william_para);
        ...
        nextActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FortWilliamPage.this, LochLinhePage.class);
